...
class Crosshits(TreeMaker):
	def __init__(self, combo, bins, **kwargs):
		...
		# TODO: add exception/fix if number of features is bigger then self.colors
...
if __name__ == '__main__':
	...
	parser.add_argument('-m', '--mode', default='combinations', choices=['combinations', 'crosshits', 'MSAclusters'],
						help='Chose the mode / kind of Tree you want to make. Options: combinations, crosshits, MSAclusters')

	# TODO: Use the GroupSystem of Argparser to make this behave properly
	...
	if args.mode == 'combinations':
		...
		extraargs = {'combo': args.combo, 'bins': bins}
		useTree = Crosshits

	else:
		print('Not a valid mode. Valid options are: combinations, crosshits, MSAclusters')
		sys.exit()
